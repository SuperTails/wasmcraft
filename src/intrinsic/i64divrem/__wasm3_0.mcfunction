...
# SetConst(HalfRegister(Work(0, 3), Lo), 63)
scoreboard players set %work%0%lo%3%temp reg 63
...
# Comment("I64ShrS")
# I64ShrS
# SetConst(HalfRegister(Work(1, 3), Lo), 63)
scoreboard players set %work%1%lo%3%temp reg 63
...
# I64ShrS { dst: Work(2, 3), lhs: Work(0, 3), rhs: Work(1, 3) }
...
scoreboard players operation %work%0%lo%3%temp reg = %stack%0%lo%3%temp reg
scoreboard players operation %work%0%hi%3%temp reg = %stack%0%hi%3%temp reg
# StoreLocalI64(Work(0, 3), 4)
execute at @e[tag=frameptr] store result block ~-5 ~ ~ RecordItem.tag.Memory int 1 run scoreboard players get %work%0%lo%3%temp reg
execute at @e[tag=frameptr] store result block ~-5 ~ ~1 RecordItem.tag.Memory int 1 run scoreboard players get %work%0%hi%3%temp reg
...
# I64Const { value: 63 }
# PushI64Const(63)
scoreboard players set %stack%2%lo%3%temp reg 63
...
scoreboard players operation %work%0%lo%3%temp reg = %stack%0%lo%3%temp reg
scoreboard players operation %work%0%hi%3%temp reg = %stack%0%hi%3%temp reg
# StoreLocalI64(Work(0, 3), 5)
execute at @e[tag=frameptr] store result block ~-6 ~ ~ RecordItem.tag.Memory int 1 run scoreboard players get %work%0%lo%3%temp reg
execute at @e[tag=frameptr] store result block ~-6 ~ ~1 RecordItem.tag.Memory int 1 run scoreboard players get %work%0%hi%3%temp reg
...
#   Branch to __wasm3_3
#   Jump to __wasm3_3
function intrinsic:i64divrem/__wasm3_3
