...
scoreboard players remove %stackptr wasm 2
execute at @e[tag=stackptr] store result score %work%0%lo reg run data get block ~ ~ ~ RecordItem.tag.Memory 1
# BranchIf { t_name: BranchTarget { label: Label { func_idx: CodeFuncIdx(1), idx: 3 }, to_pop: 0, ty: [] }, f_name: BranchTarget { label: Label { func_idx: CodeFuncIdx(1), idx: 4 }, to_pop: 0, ty: [] }, cond: Work(0) }
#   BranchIf { t_name: BranchTarget { label: Label { func_idx: CodeFuncIdx(1), idx: 3 }, to_pop: 0, ty: [] }, f_name: BranchTarget { label: Label { func_idx: CodeFuncIdx(1), idx: 4 }, to_pop: 0, ty: [] }, cond: Work(0) }
...
#   Branch to __wasm1_3
# RawBranch(Label { func_idx: CodeFuncIdx(1), idx: 3 })
#   Jump to __wasm1_3
execute unless score %%tempcond reg matches 0..0 run function intrinsic:i64divrem/__wasm1_3
execute at @e[tag=condstackptr] store result score %%tempcond reg run data get block ~-1 ~ ~ RecordItem.tag.Memory 1
#   Branch to __wasm1_4
# RawBranch(Label { func_idx: CodeFuncIdx(1), idx: 4 })
#   Jump to __wasm1_4
execute if score %%tempcond reg matches 0..0 run function intrinsic:i64divrem/__wasm1_4
execute at @e[tag=condstackptr] as @e[tag=condstackptr] run tp @s ~-1 ~ ~