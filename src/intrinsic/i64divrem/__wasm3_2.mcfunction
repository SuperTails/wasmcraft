...
# I64Const { value: -1 }
# PushI64Const(-1)
scoreboard players set %stack%4%lo reg -1
scoreboard players set %stack%4%hi reg -1
# Comment("I64GtS")
# I64GtS
# PopI64Into(Work(1))
...
# I64Const { value: 63 }
# PushI64Const(63)
scoreboard players set %stack%5%lo reg 63
...
scoreboard players operation %stack%4%hi reg = %work%2%hi reg
# Comment("I32WrapI64")
# I32WrapI64
# PopI64Into(Work(0))
scoreboard players operation %work%0%lo reg = %stack%4%lo reg
...
execute at @e[tag=localptr] store result score %work%0%hi reg run data get block ~ ~ ~1 RecordItem.tag.Memory 1
# PushI64From(Work(0))
scoreboard players operation %stack%5%lo reg = %work%0%lo reg
scoreboard players operation %stack%5%hi reg = %work%0%hi reg
# Comment("I64Const { value: 0 }")
# I64Const { value: 0 }
# PushI64Const(0)
scoreboard players set %stack%6%lo reg 0
scoreboard players set %stack%6%hi reg 0
# Comment("I64LtS")
# I64LtS
# PopI64Into(Work(1))
scoreboard players operation %work%1%lo reg = %stack%6%lo reg
scoreboard players operation %work%1%hi reg = %stack%6%hi reg
# PopI64Into(Work(0))
scoreboard players operation %work%0%lo reg = %stack%5%lo reg
scoreboard players operation %work%0%hi reg = %stack%5%hi reg
...
# PushI32From(Work(2))
scoreboard players operation %stack%5%lo reg = %work%2%lo reg
# Comment("Select")
# Select
# PopI32Into(Work(2))
scoreboard players operation %work%2%lo reg = %stack%5%lo reg
# PopI32Into(Work(1))
scoreboard players operation %work%1%lo reg = %stack%4%lo reg
# PopI32Into(Work(0))
scoreboard players operation %work%0%lo reg = %stack%3%lo reg
...
scoreboard players operation %work%0%lo reg = %stack%1%lo reg
scoreboard players operation %work%0%hi reg = %stack%1%hi reg
# SetConst(HalfRegister(Work(2), Lo), 0)
scoreboard players set %work%2%lo reg 0
# SetConst(HalfRegister(Work(2), Hi), 0)
scoreboard players set %work%2%hi reg 0
# I32MulTo64 { dst: Work(3), lhs: HalfRegister(Work(0), Lo), rhs: HalfRegister(Work(1), Lo) }
scoreboard players operation %param0%0 reg = %work%0%lo reg
scoreboard players operation %param1%0 reg = %work%1%lo reg
function intrinsic:mul_32_to_64
scoreboard players operation %work%3%lo reg = %return%0 reg
scoreboard players operation %work%3%hi reg = %return%1 reg
# I32Op { dst: HalfRegister(Work(0), Lo), lhs: HalfRegister(Work(0), Lo), op: "*=", rhs: HalfRegister(Work(1), Hi) }
scoreboard players operation %work%0%lo reg *= %work%1%hi reg
# I32Op { dst: HalfRegister(Work(0), Hi), lhs: HalfRegister(Work(0), Hi), op: "*=", rhs: HalfRegister(Work(1), Lo) }
scoreboard players operation %work%0%hi reg *= %work%1%lo reg
# I32Op { dst: HalfRegister(Work(2), Lo), lhs: HalfRegister(Work(2), Lo), op: "+=", rhs: HalfRegister(Work(3), Lo) }
scoreboard players operation %work%2%lo reg += %work%3%lo reg
# I32Op { dst: HalfRegister(Work(2), Hi), lhs: HalfRegister(Work(2), Hi), op: "+=", rhs: HalfRegister(Work(3), Hi) }
scoreboard players operation %work%2%hi reg += %work%3%hi reg
# I32Op { dst: HalfRegister(Work(2), Hi), lhs: HalfRegister(Work(2), Hi), op: "+=", rhs: HalfRegister(Work(0), Lo) }
scoreboard players operation %work%2%hi reg += %work%0%lo reg
# I32Op { dst: HalfRegister(Work(2), Hi), lhs: HalfRegister(Work(2), Hi), op: "+=", rhs: HalfRegister(Work(0), Hi) }
scoreboard players operation %work%2%hi reg += %work%0%hi reg
# PushI64From(Work(2))
scoreboard players operation %stack%1%lo reg = %work%2%lo reg
scoreboard players operation %stack%1%hi reg = %work%2%hi reg
