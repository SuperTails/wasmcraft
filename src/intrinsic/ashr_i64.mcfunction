...
execute if score %param1%0 reg matches 1.. run scoreboard players operation %param1%0 reg += %%temp_sign reg
scoreboard players remove %param1%0 reg 1

execute if score %param1%0 reg matches 1.. run function intrinsic:lshr_i64